...
Snapshot: 2026-09-19 UTC. Source and v0.1.0-alpha.1 are public. The submitted
application described the 137-test first release; later measurements below do not
retroactively change its exact submitted fields.
...
| MCP and host | [Actual Codex call](../evidence/codex-host.md), [installed plugin](../evidence/plugin-host.md), [workflow ledger](../evidence/codex-workflow.md) | Each report states the observed host scope and any pending/failed cases |
...
| OSS program | Submitted; OpenAI success message observed | Acceptance and benefit unknown |
